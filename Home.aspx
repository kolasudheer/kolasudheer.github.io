...
<html lang="en">
				...
				<div class="primary-header">
					<div class="container">
						<a href="Home.aspx" id="branding">
							...
							<h1 class="site-title">Star Eductaionals</h1>
                                <asp:LinkButton ID="LinkButton3" runat="server" class="button primary large" Style="margin-bottom: 10px; margin-left: 850px" OnClick="LinkButton3_Click">Login</asp:LinkButton>
						</a> <!-- #branding -->
    ...
    <asp:LinkButton ID="LinkButton1" runat="server" class="button primary large" OnClick="LinkButton1_Click">Star Kids</asp:LinkButton>
    <asp:LinkButton ID="LinkButton2" runat="server" class="button primary large" OnClick="LinkButton2_Click">Star Five</asp:LinkButton>
									</div>
				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="widget">
							...
							<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3881.7056305246015!2d79.1948292!3d13.3685712!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xeebe5d5218a7e05a!2sstar+kids+play+school!5e0!3m2!1sen!2sin!4v1554790912133!5m2!1sen!2sin" width="300" height="200" frameborder="0" style="border:0" allowfullscreen></iframe>
						</div>
					</div>
				</div>
