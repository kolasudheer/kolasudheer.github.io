				...
				<div class="bar-holder">
					...
					<nav id="nav">
						<ul>
							...
							<li><a href="gallerys.aspx">Gallery</a></li>
<%--							<li><a href="index.html">Contact</a></li>--%>
			...
			<section class="promo">
				<div class="slider-wrap">
					<ul class="slider">
						<li>
							<img class="slide" src="imagess/gree6.jpg" alt="">
							<img class="slide-mask" src="imagess/bg_slider-mask.png" alt="">
						...
						<li>
							<img class="slide" src="imagess/gree7.jpg" alt="">
							<img class="slide-mask" src="imagess/bg_slider-mask.png" alt="">
							<div class="slide-info">
								<h1><a href="#">Education for kids</a></h1>
								<p>Accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi.</p>
					...
					<div class="widget-boxes news">
						...
						<div class="box">
							<a class="news-img" href="#">
								<img src="imagess/img-news01.jpg" alt="" />
								<div class="mask"></div>
							</a>
							<div class="box-info">
						...
						<div class="box">
							<a class="news-img" href="#">
								<img src="imagess/img-news02.jpg" alt="" />
								<div class="mask"></div>
							</a>
							<div class="box-info">
						...
						<div class="box">
							<a class="news-img" href="#">
								<img src="imagess/img-news03.jpg" alt="" />
								<div class="mask"></div>
							</a>
							<div class="box-info">
